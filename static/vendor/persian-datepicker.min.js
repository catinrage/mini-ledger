          ...
          return (
            a(e, [
              ...
              },
              {
                ...
                value: function () {
                  this.model &&
                    (this.model.view.destroy(), this.model.options.onDestroy(this.model), delete this.model);
                },
              },
              {
                key: 'setDate',
                ...
                value: function () {
                  var e = this,
                    t = function t(i) {
                      $(i.target).is(e.elem) ||
                        ...
                        0 != $(i.target).closest('#' + e.model.view.$container.attr('id')).length ||
                  ...
                  $(this.elem).on(
                    ...
                    o.debounce(function (i) {
                      return (
                        e.model.api.show(),
                        !1 === e.model.state.ui.isInline && $('body').unbind('click', t).bind('click', t),
              ...
              },
              {
                ...
                value: function () {
                  var e = null,
                    ...
                    i = void 0;
                  if (
                    (i = 'INPUT' === t[0].nodeName ? t[0].getAttribute('value') : t.data('date')) &&
                ...
                value: function () {
                  if (this.model.options.navigator.scroll.enabled) {
                    ...
                    o(t).wheel(function (t, i) {
                      i > 0 ? e.model.state.navigate('next') : e.model.state.navigate('prev'),
                        e.model.view.render(),
                        t.preventDefault();
                    }),
                  ...
                  if (void 0 != this.model.options.timePicker[e]) {
                    ...
                    'meridian' == e
                      ...
                      : ((t = this.model.options.timePicker[e].step),
                        (i = this.model.PersianDate.date(this.model.state.selected.unixDate)
                          .add(e, t)
                          .valueOf())),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.model.options.navigator.enabled &&
                    $(document).on('click', '#' + e.model.view.id + ' .pwt-btn', function () {
                    ...
                    this.model.options.timePicker.enabled &&
                      ($(document).on('click', '#' + e.model.view.id + ' .up-btn', function () {
                      ...
                      $(document).on(
                        ...
                        function () {
                          ...
                          e.model.state.setSelectedDateTime('unix', t),
                            ...
                            e.model.state.setViewDateTime('unix', e.model.state.selected.unixDate),
                    ...
                    this.model.options.yearPicker.enabled &&
                      $(document).on(
                        'click',
                        '#' + e.model.view.id + ' .datepicker-year-view .year-item:not(.year-item-disable)',
                        function () {
            ...
            a(e, [
              {
                ...
                value: function (e) {
                  e.inline && (e.toolbox.submitButton.enabled = !1),
                    ...
                    null === e.timePicker.hour.step && (e.timePicker.hour.step = e.timePicker.step),
            ...
            a(e, [
              {
                ...
                value: function (e) {
                  ...
                  return (
                    ...
                    this.model.options.calendar[this.model.options.calendarType].leapYearMode &&
                      n.toLeapYearMode(
                        this.model.options.calendar[this.model.options.calendarType].leapYearMode,
                      ),
                    (i = new n(e)),
            ...
            a(e, [
              ...
              },
              {
                ...
                value: function (e) {
                  if ('next' == e) {
                    if (
                      ('year' == this.viewMode && this.setViewDateTime('year', this.view.year + 12),
                      'month' == this.viewMode)
                    ) {
                    ...
                    if ('day' == this.viewMode) {
                      ...
                      0 === i && (i = 1),
                        this.view.month + 1 == 13
                          ? (this.setViewDateTime('year', i), this.setViewDateTime('month', 1))
              ...
              },
              {
                ...
                value: function () {
                  return (
                    (this.viewModeIndex =
                      this.viewModeIndex + 1 >= this.viewModeList.length ? 0 : this.viewModeIndex + 1),
              ...
              },
              {
                ...
                value: function (e) {
                  this.viewModeList.indexOf(e) >= 0 &&
                    ((this.viewMode = e), (this.viewModeIndex = this.viewModeList.indexOf(e)));
                },
              },
              {
                  ...
                  $(document).on('click', '#' + e.model.view.id + ' .pwt-btn-today', function () {
                    ...
                    $(document).on('click', '#' + e.model.view.id + ' .pwt-btn-calendar', function () {
                      e._toggleCalendartype(),
                        e.model.state.setSelectedDateTime('unix', e.model.state.selected.unixDate),
            ...
            s(e, [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  'auto' === this.model.options.position
                    ? this.$container.css({ left: e.left + 'px', top: t.height + e.top + 'px' })
                    : this.$container.css({
                ...
                value: function (e) {
                  ...
                  return (
                    'day' == this.model.state.viewMode
                      ? (t = this.model.options.dayPicker.titleFormatter.call(this, e.year, e.month))
                      : 'month' == this.model.state.viewMode
                        ...
                        : 'year' == this.model.state.viewMode &&
                          (t = this.model.options.yearPicker.titleFormatter.call(this, e.year)),
                    t
                  );
                },
              },
              ...
              },
              {
                ...
                value: function () {
                  ...
                  try {
                    for (
                      var r, l = i.model.PersianDate.date().rangeName().months.entries()[Symbol.iterator]();
                      !(n = (r = l.next()).done);
                      n = !0
                    ) {
                      var d = o(r.value, 2),
                ...
                value: function (e) {
                  ...
                  if (
                    ...
                    if (t.minDate && t.maxDate) {
                      if (
                        ((t.minDate = t.model.PersianDate.date(t.minDate).startOf('day').valueOf()),
                        (t.maxDate = t.model.PersianDate.date(t.maxDate).endOf('day').valueOf()),
                          ...
                          0 === y && M < s
                            ...
                            : (0 === y && M >= s) || (y <= 5 && l < a)
                              ? ((l += 1),
                                ...
                                (O = !1))
                              : ((d += 1),
                                (S = this.model.state.view.dateObject.endOf('month').hour(12).add('days', d)),
                                (O = !0)),
                            r[y].push({
                              title: S.format('D'),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    'persian' == e.model.options.calendar_
                      ? ((t = 'gregorian'), (i = e.model.options.calendar.gregorian.locale))
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.$container.find('[data-time-key="hour"] input').val(e.hour.title),
                    this.$container.find('[data-time-key="minute"] input').val(e.minute.title),
                    this.$container.find('[data-time-key="second"] input').val(e.second.title),
                    this.$container.find('[data-time-key="meridian"] input').val(e.meridian.title);
                },
              },
              {
                key: 'render',
                value: function (e) {
                  e || (e = this.model.state.view),
                    l.debug(this, 'render'),
                    d.parse(r),
                    (this.rendered = $(d.render(this.model.options.template, this.getViewModel(e)))),
      ...
      !(function (t, i) {
          ...
          (n.Instance.prototype = {
            wheel: function (e, t) {
              return (
                ...
                'DOMMouseScroll' === n.SUPPORT && n.event.add(this, 'MozMousePixelScroll', e, t),
                this
              );
            },
            unwheel: function (e, t) {
              return (
                ...
                'DOMMouseScroll' === n.SUPPORT && n.event.remove(this, 'MozMousePixelScroll', e, t),
                this
              );
            },
          }),
        ...
        (n.normalise = {
          browser: function () {
            'onwheel' in i ||
              i.documentMode >= 9 ||
              (n.SUPPORT = void 0 !== i.onmousewheel ? 'mousewheel' : 'DOMMouseScroll'),
              t.addEventListener ||
                ((n.ADD_EVENT = 'attachEvent'), (n.REMOVE_EVENT = 'detachEvent'), (n.PREFIX = 'on'));
          },
          event: function (e) {
            var t = {
              originalEvent: e,
